...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            <h1 class="mt-2"> data batas wilayah jalan</h1>
            <?php if (session()->getFlashdata('pesan')) : ?>
                <div class="alert alert-success" role="alert">
                    <?= session()->getFlashdata('pesan'); ?>
                </div>
            <?php endif; ?>
            <a href="/jalan/create" class="btn btn-primary mt-3">Tambah</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="/jalan/edit/<?= $b['id']; ?>" class="btn btn-success">edit</a></td>
                            <td>
                                <form action="/jalan/delete/<?= $b['id']; ?>" method="POST">
                                    <?= csrf_field(); ?>
