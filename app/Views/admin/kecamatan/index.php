...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-10">
            <h1 class="mt-2"> data batas wilayah kecamatan</h1>
            <?php if (session()->getFlashdata('pesan')) : ?>
                <div class="alert alert-success" role="alert">
                    <?= session()->getFlashdata('pesan'); ?>
                </div>
            <?php endif; ?>
            <a href="/kelurahan/createkec" class="btn btn-primary mt-3">Tambah</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a href="/kelurahan/editkec/<?= $b['id']; ?>" class="btn btn-success">edit</a></td>
                            <td>
                                <form action="/kelurahan/deletekec/<?= $b['id']; ?>" method="POST">
                                    <?= csrf_field(); ?>
